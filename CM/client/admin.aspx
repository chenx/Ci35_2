<%@ Page Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="admin.aspx.cs" Inherits="client_admin" Title="Site Admin" EnableViewState="false"%>
...
<% /*<p><a href='client_new.aspx'>Add New Client</a></p>*/ %>
<p><br/></p>
